...
exports.withDragAndDropContext = withDragAndDropContext
exports.withDrag = withDrag
...
function withDragAndDropContext(Element) {
  var DragAndDropContext =
    /*#__PURE__*/
    (function(_React$Component2) {
      ;(0, _inheritsLoose2.default)(DragAndDropContext, _React$Component2)
      ...
      var _proto2 = DragAndDropContext.prototype
  ...
  DragAndDropContext.defaultProps = {
    draggableAccessor: null,
    resizableAccessor: null,
  }
  DragAndDropContext.childContextTypes = {
    draggable: _propTypes.default.shape({
      onStart: _propTypes.default.func,
      onEnd: _propTypes.default.func,
      onBeginAction: _propTypes.default.func,
...
function withDrag(Element) {
  var DragWrapper =
    /*#__PURE__*/
    (function(_React$Component3) {
      ;(0, _inheritsLoose2.default)(DragWrapper, _React$Component3)
      ...
      function DragWrapper() {
        ...
        _this3.handleStartDragging = function(e) {
          if (e.button === 0) {
            _this3.context.draggable.onBeginAction(_this3.props.event, 'move')
          }
        }
      ...
      var _proto3 = DragWrapper.prototype
      ...
      _proto3.render = function render() {
        ...
        if (event.__isPreview) {
          ...
          return _react.default.createElement(Element, newProps)
        }
